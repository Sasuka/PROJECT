<div class="main-content">
    <div>
            ...
            <script>
                if(typeof ga != 'undefined') {
                    ...
                    ga('ecommerce:addItem', {
                        ...
                        'sku': '', // SKU/code.
                        'category': 'Đồng hồ nam Skmei', // Category or variation.
                    ...
                    ga('ecommerce:addItem', {
                        ...
                        'sku': '', // SKU/code.
                        'category': 'Đồng hồ nam Tevise', // Category or variation.
        ...
        <div class="step-footer">
            ...
            <button class="step-footer-continue-btn btn" id="continue">
                <span class="btn-content">Tiếp tục mua hàng</span>
            </button>
            <p class="step-footer-info">
                <i class="icon icon-os-question"></i>
                <span>
					 Cần hỗ trợ? <a href="<?php echo base_url('home')?>">Liên hệ chúng tôi</a>
                </span>
            </p>
        </div>
    </div>
