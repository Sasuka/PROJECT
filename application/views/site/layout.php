                ...
                $.ajax({
                    ...
                    success: function (product) {
                       ...
                       // alert(pro['MA_SANPHAM']);
                        ...
                        $('.quickview-information').find('.btnAction').find('.qv-readmore').find('.read-more')
                            .attr('href','http://localhost/www/PROJECT/product/show_product_detail/'+pro['MA_SANPHAM']);
